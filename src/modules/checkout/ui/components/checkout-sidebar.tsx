    ...
    <div className="border rounded-md overflow-hidden bg-white flex flex-col">
      ...
      <div className="p-4 flex items-center justify-center">
        <Button
          ...
          onClick={onCheckout}
          size={"lg"}
          className="text-base w-full text-white bg-primary hover:bg-blue-400 hover:text-primary"
        >
          Checkout
        </Button>
      </div>
      {isCanceled && (
        <div className="p-4 flex justify-center items-center border-t">
          <div className="bg-red-100 border-red-400 font-medium px-4 py-3 rounded relative flex items-center w-full">
